var $api = new apiUtils.Api(apiUrl + '/pages/cms/contentsLayerTransmit');
var $apiChannels = new apiUtils.Api(apiUrl + '/pages/cms/contentsLayerTransmit/actions/getChannels');
